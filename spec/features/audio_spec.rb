...
feature 'Audio' do
  ...
  scenario 'View MS123 (Interview with Horace Works) participants' do
    visit '/concern/audios/1234jt5bg'
  ...
  scenario 'View MS123 (Interview with Horace Works) information tab visibility' do
    visit '/concern/audios/1234jt5bg'
  ...
  scenario 'View MS123 (Interview with Horace Works) information tab content' do
    visit '/concern/audios/1234jt5bg'
    expect(page).to have_link 'Information', href: '#information'
    click_link 'Information'
  ...
  scenario 'View MS123 (Interview with Horace Works) transcript tab visibility' do
    visit '/concern/audios/1234jt5bg'
  ...
  scenario 'View MS123 (Interview with Horace Works) transcript tab content' do
    visit '/concern/audios/1234jt5bg'
    expect(page).to have_link 'Transcript', href: '#transcript'
    click_link 'Transcript'
  ...
  scenario 'View MS123 (Interview with Horace Works) transcript only page' do
