...
feature 'EAD' do
  ...
  scenario 'View MS999 (Lorem Ipsum papers/"kitchen sink") landing page' do
    ...
    expect(page).to have_text "Lorem Ipsum papers, 1897-1933. Tufts University. Tufts Archival Research Center. Medford, MA."
    ...
    expect(page).to have_text "Personal papers, Lorem Ipsum papers, 1897-1933. Tufts University. Tufts Archival Research Center. Medford, MA."
